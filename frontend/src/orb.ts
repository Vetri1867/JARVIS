/**
 * SHADOW — Multi-mode particle visualization.
 *
...
export function createOrb(canvas: HTMLCanvasElement): Orb {
  ...
  const mat = new THREE.PointsMaterial({
    color: 0x00d4ff, size: 0.4, transparent: true, opacity: 0.6,
  ...
  function animate() {
    ...
    if (state === "thinking") { mat.color.lerp(new THREE.Color(0x00eaff), 0.015); lineMat.color.lerp(new THREE.Color(0x00eaff), 0.015); }
    else if (state === "speaking") { mat.color.lerp(new THREE.Color(0x00d4ff), 0.015); lineMat.color.lerp(new THREE.Color(0x00d4ff), 0.015); }
    else { mat.color.lerp(new THREE.Color(0x00d4ff), 0.015); lineMat.color.lerp(new THREE.Color(0x00d4ff), 0.015); }
