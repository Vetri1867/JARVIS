"""
SHADOW Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("shadow.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (SHADOW personality)
