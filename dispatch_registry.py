"""
SHADOW Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so SHADOW always knows what he's working on,
...
log = logging.getLogger("shadow.dispatch")
