"""
SHADOW Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("shadow.browser")
...
class ShadowBrowser:
    """Playwright-based web browsing for SHADOW."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch SHADOW browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="shadow_screenshot_")
                path = tmp
