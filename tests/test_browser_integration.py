"""
Browser integration tests for SHADOW.
...
from browser import ShadowBrowser, SearchResult, PageContent
...
async def test_browser_screenshot(browser):
    ...
    tmp_path = tempfile.mktemp(suffix=".png", prefix="shadow_test_ss_")
